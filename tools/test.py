...
def parse_args():
    ...
    # 
    parser.add_argument('--weights', nargs='+', type=str, default='/home/YOLOP/log/20211217_083224_lr_1e-03_b_80/ep014.pth', help='model.pth path(s)')
...
def main():
    ...
    test_loader = get_test_loader(cfg, cfg.TEST.BATCH_SIZE, cfg.LANE.DATASET, distributed)
    # Data loading
